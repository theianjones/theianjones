...
function initSearch() {
  ...
  request.open('GET', 'https://garden.ianjones.us/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'https://garden.ianjones.us/assets/css/just-the-docs-' + theme + '.css');
}
